    ...
    return (
        <>
            <section className="
                ...
                mt-[2rem] sm:mt-[8rem] lg:mt-[6.5rem] xl:mt-[7.5rem] 2xl:mt-[8rem]
            ...
            ">
                ...
                ">
                    <h2 className="
                        text-[1.4rem] sm:text-[3rem] lg:text-[2.4rem] xl:text-[2.7rem] 2xl:text-[3rem]
                    ...
                    ">
                        {contactData.map((item) => (
                            <div key={item.id} className="
                                ...
                                mb-[1rem] sm:mb-[1.2rem] lg:mb-[1.1rem] xl:mb-[1.2rem] 2xl:mb-[1.25rem]
                            "
                                    ...
                                    ">
                                        {item.socials.map((social, i) => (
                                            <a key={i} href={social.link} target="_blank" rel="noopener noreferrer" className="
                                                ...
                                                text-[1rem] sm:text-[1.2rem] lg:text-[1rem] xl:text-[1.1rem] 2xl:text-[1.2rem]
