    ...
    return (
        <>
            <section className="
                ...
                py-[3rem] sm:py-[2rem] lg:py-[2.4rem] xl:py-[2.7rem] 2xl:py-[3rem]
            ">
                <h4 className="
                            ...
                            relatedProductsData.map((item, index) => {
                                return (
                                    <SwiperSlide key={index} className="
                                        ...
                                        px-[1rem] sm:px-[1rem] lg:px-[0.7rem] xl:px-[0.8rem] 2xl:px-[1rem]
                                    ">
                                        <div className="
                                        ...
                                        ">
                                            ...
                                            <Link to="/products/product-name" className="
                                                text-[0.7rem] sm:text-[0.8rem] lg:text-[0.7rem] xl:text-[0.75rem] 2xl:text-[0.8rem]
