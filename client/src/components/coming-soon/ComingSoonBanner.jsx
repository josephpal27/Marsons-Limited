    ...
    return (
        <>
            <section className="relative">
                ...
                ">
                    <h1 className="
                        text-[2rem] sm:text-[4rem] lg:text-[4rem] xl:text-[4.6rem] 2xl:text-[5rem]
                        text-center text-[#fff] font-[600] uppercase
                        mt-[4rem] sm:mt-[4rem] lg:mt-[3.4rem] xl:mt-[3.7rem] 2xl:mt-[4rem]
                    ">
                        Page Under <br /> 
                        <span className="
                    ...
                    <Link to="/" className="
                        ...
                        mt-[4.5rem] sm:mt-[4rem] lg:mt-[3.5rem] xl:mt-[3.8rem] 2xl:mt-[4rem]
