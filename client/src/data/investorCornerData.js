export const investorCornerData = {
  ...
  "regulation": {
    ...
    accordion: [
      ...
      {
        id: 4,
        title: "Code of conduct of Board of Directors and Senior Personnel",
        body: [
          {
      ...
      {
        id: 9,
        title: "Details of Familization Programmes imparted to Independent Directors",
        body: [
          {
      ...
      {
        id: 10,
        title: "Email Id for grievance redressal",
        body: [],
      },
      {
        id: 11,
        title: "Contact details for handling Investor grievances",
        body: [
          {
      ...
      {
        id: 14,
        title: "Details of agreements entered into with the media/companies and/or associates",
        body: [],
      },
      {
        id: 15,
      ...
      {
        id: 16,
        title: "New Name and the Old Name of the listed entity",
        body: [],
      },
      {
        id: 17,
        title: "Dividend Distribution Policy as per Regulation 43A(1)",
        body: [
          {
      ...
      {
        id: 18,
        title: "Materiality Policy as per Regulation 30(4)",
        body: [
          {
      ...
      {
        id: 28,
        title: "Separate Audited Finacial Statements of each subsidiary of the listed entity",
        body: [
          {
  ...
  "corporate-governance": {
    ...
    accordion: [
      ...
      {
        id: 2,
        title: "Details of familiarisation Programme",
        body: [
          {
      ...
      {
        id: 3,
        title: "Terms of Appointment of Independent Directors",
        body: [
          {
  ...
  "notices-and-results": {
    ...
    accordion: [
      ...
      {
        id: 2,
        title: "Book Closure And Record Details",
        body: [],
      },
      {
        id: 3,
      ...
      {
        id: 4,
        title: "Postal Ballot And Voting Result",
        body: [],
      },
      {
        id: 5,
      ...
      {
        id: 8,
        title: "1st EGM for FY 2023-24- Preferential Allotment of Shares",
        body: [],
      },
      {
        id: 9,
        title: "2nd EGM for FY 2023-24- Preferential Allotment of Shares",
        body: [],
      },
      {
        id: 10,
      ...
      {
        id: 15,
        title: "1st Interim Dividend 2025-26",
        body: [
          {
